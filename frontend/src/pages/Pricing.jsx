  ...
  return (
    ...
    px-6 pt-10 pb-24'>
        <div className='absolute inset-0 pointer-events-none'>
            ...
            bg-indigo-600/20 rounded-full blur-[120px]'></div>
            <div className='absolute bottom-0 right-0 w-[400px] h-[400px]
            bg-purple-600/20 rounded-full blur-[120px]'></div>
        </div>

        <button className='relative z-10 mb-8 flex items-center gap-2 text-sm
        text-zinc-400 hover:text-white transition' onClick={() => navigate("/")}>
            <ArrowLeft size={16} />
            Back
        </button>
        <motion.div
        ...
        <div className='relatiev z-10 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8'>
            {plans.map((p,i) => (
                <motion.div
                   key={i}
