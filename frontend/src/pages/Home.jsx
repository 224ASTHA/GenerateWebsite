      ...
      border-b border-white/10'>
        <div className='max-w-7xl mx-auto px-6 py-4 flex justify-between items-center'>
            <div className='text-lg font-semibold'>
                {/* Logo - left side things */}
                GenWeb.ai
            </div>
            <div className='flex items-center gap-5'>
                {/* Right side things */}
                <div className='hidden md:inline text-sm text-zinc-300 hover:text-white cursor-pointer'
                ...
                hover:bg-white/10 transition' onClick={() => navigate("/pricing")}>
                ...
                <div className='relative'>
                    ...
                    <img src={userData.avatar || `https://ui-avatars.com/api/?name=${userData.username}`} 
                     alt='profile'
                    ...
                    <AnimatePresence>
                        {openProfile && (
                            ...
                            >
                                ...
                                <button className='md:hidden px-4 py-3 items-center gap-2
                                        border border-b border-white/10 text-sm 
                                        hover:bg-white/5 '>
                                    <Coins size={14} className='text-yellow-400'/>
                                    <span className='text-zinc-300'>Credits</span>
                                    <span>{userData.credits}</span>
                                ...
                                text-left text-sm hover:bg-white/5'
       ...
       <section className='pt-44 pb-29 px-6 text-center'>
         <motion.h1
        ...
        >
         ...
         <button className='px-10 py-4 rounded-xl bg-white text-black font-semibold
...
{/* the login will be seen not seen depend on the openLogin */}
{openLogin && <LoginModel open={openLogin} 
onClose={
    () => setOpenLogin(false)
}/>} 
    </div>
