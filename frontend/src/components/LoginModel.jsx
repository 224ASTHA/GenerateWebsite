...
function LoginModel ({open, onClose}) {
  ...
  return (
    <AnimatePresence>
    {open && <motion.div 
    className='fixed inset-0 z-0 flex items-center justify-center bg-black/80 backdrop-blur-xl px-4'
    initial={{ opacity: 0 }}
    animate={{ opacity: 1 }}
    exit={{ opacity: 0 }}
    onClick={onClose}
            ...
            shadow-[0_30px_120px_rgba(0,0,0,0.8)] overflow-hidden'>
                ...
                <div className='relative px-8 pt-14 pb-10 text-center'>
                    ...
                    >
                        ...
                        <img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRVCvLeTHwisItiq2ogbeAY_JJe5SBA38iLCA&s' 
